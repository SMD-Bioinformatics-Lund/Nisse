process PREPARE_VCF {
    ...
    zcat ${vcf} | sed "/#CHROM/i ##INFO=<ID=Pathogenicity,Number=1,Type=Integer,Description=\\\"Placeholder to not crash genmod\\\">" | sed "/ID=VDB/ s/,Version=\\\"3\\\"//" | grep -P '^#|^chr[1-9]\\\b|^chr[12][0-9]\\\b|^chr[MXY]\\\b' > ${meta.sample}_prepared.vcf
